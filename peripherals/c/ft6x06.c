...
{ 
  ...
  // register will be 0, 1, or 2.
	uint8_t data;
	ft6x06_set_addr(I2C1_BASE,FT6X06_TD_STATUS_R);
	ft6x06_read_data(I2C1_BASE,&data);
	data = data&0xf;
	if (data>2)
		return 0;
	else
...
{ 
  ...
  // This will require reading P1_XH and P1_XL
	uint8_t dataH, dataL;
	uint16_t data;
	ft6x06_set_addr(I2C1_BASE,FT6X06_P1_XH_R);
	ft6x06_read_data(I2C1_BASE,&dataH);
	ft6x06_set_addr(I2C1_BASE,FT6X06_P1_XL_R);
	ft6x06_read_data(I2C1_BASE,&dataL);
	data = 239 - ((dataH&0xf)<<8 | (dataL&0xff));
	return data;
} 
...
{ 
  ...
  // This will require reading P1_YH and P1_YL
	uint8_t dataH, dataL;
	uint16_t data;
	ft6x06_set_addr(I2C1_BASE,FT6X06_P1_YH_R);
	ft6x06_read_data(I2C1_BASE,&dataH);
	ft6x06_set_addr(I2C1_BASE,FT6X06_P1_YL_R);
	ft6x06_read_data(I2C1_BASE,&dataL);
	data = 319 - ((dataH&0xf)<<8 | (dataL&0xff));
	return data;
} 
